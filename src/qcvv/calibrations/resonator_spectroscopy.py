...
@store
def resonator_spectroscopy_optimize(
    platform: AbstractPlatform,
    qubit,
    width,
    maxiter = 500,
    ...
    def resonator_probe(freq):
        platform.ro_port[qubit].lo_frequency = freq[0] - ro_pulse.frequency
    ...
    yield optimized_sweep_data
    res = minimize(resonator_probe, resonator_frequency - width, method='Powell',
                            bounds=bounds,
