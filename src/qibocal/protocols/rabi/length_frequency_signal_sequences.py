...
@dataclass
class RabiLengthFreqSequencesParameters(Parameters):
...
@dataclass
class RabiLengthFreqSequencesResults(RabiLengthSignalResults):
...
@dataclass
class RabiLengthFreqSequencesData(Data):
    """RabiLengthFreqSequences data acquisition."""
...
def _acquisition(
    params: RabiLengthFreqSequencesParameters,
    platform: Platform,
    targets: list[QubitId],
) -> RabiLengthFreqSequencesData:
    ...
    data = RabiLengthFreqSequencesData(amplitudes=amplitudes)
...
def _fit(data: RabiLengthFreqSequencesData) -> RabiLengthFrequencySignalResults:
...
def _plot(
    data: RabiLengthFreqSequencesData,
    target: QubitId,
