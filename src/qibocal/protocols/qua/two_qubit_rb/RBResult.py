...
def get_interleaved_gate_fidelity(
    num_qubits: int, reference_alpha: float, interleaved_alpha: float
):
    """
    ...
    """
    return 1 - (
        (2**num_qubits - 1) * (1 - interleaved_alpha / reference_alpha) / 2**num_qubits
    )
