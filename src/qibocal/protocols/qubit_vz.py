...
phi: the values of the elative phase sweep of the second pi/2 pulse, prob: probability of state |1>.
"""
...
def _fit_function(phi, theta, amp, offset):
    ...
    This is the probabilty of state |1> as derived from theory, plus some additional parameters (amp and offset)
