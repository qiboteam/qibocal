...
@dataclass
class DriveShapeParameters(Parameters):
...
@dataclass
class DriveShapeResults(Results):
...
def _fit(data: DriveShapeData) -> DriveShapeResults:
    qubits = data.qubits
...
def _update(
    results: DriveShapeResults, platform: Platform, target: QubitId
):
...
"""Iterative Qubit classification routine object."""
