...
@dataclass
class CrosstalkParameters(QubitFluxParameters):
...
@dataclass
class CrosstalkData(QubitFluxData):
...
def _acquisition(
    ...
    data = CrosstalkData(resonator_type=platform.resonator_type, Ec=Ec, Ej=Ej)
