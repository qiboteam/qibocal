...
from ..ramsey.ramsey_signal import (
    RamseySignalData,
...
from .utils import ramsey_sequence_mro
...
class RamseyParameters(RamseySignalParameters):
    ...
    measure_qubits: Optional[QubitId] = None
...
def _acquisition(
    ...
    data = RamseyData(
        ...
        qubit_ros=params.measure_qubits,
    )
...
frustration_ramsey = Routine(_acquisition, _fit, _plot, _update)
