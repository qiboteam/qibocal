...
def drive_frequency(freq: Union[float, list], platform: Platform, qubit: QubitId):
...
def drive_amplitude(amp: Union[float, list], platform: Platform, qubit: QubitId):
    """Update drive frequency value in platform for specific qubit."""
...
def drive_duration(duration: Union[int, list], platform: Platform, qubit: QubitId):
