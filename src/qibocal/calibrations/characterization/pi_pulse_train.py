...
# TODO: They are the same routine, just different plotting and acquire mode
@plot("Qubit States", plots.qubit_states_trains)
def pi_pulse_train_calibrate_qubit_states(
    platform: AbstractPlatform,
    qubits: dict,
    number_of_pairs,
    nshots,
